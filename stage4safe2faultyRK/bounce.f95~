...
do tEquiv=1,50
   ...
   call cpu_time(temp1)   
   !collisionAlgorithm
   call iterateTheseManyTimes(tN,collisionAlgorithm,plotGraphs=1)
   call cpu_time(temp2)
  ...
  subroutine init(parametricT,spooky)
    ...
    do i=1,macroscopic%N
       ...
       !Its the spooknfiguration
          ...
          frame%particles(i)%qDot(1)=20.0 !abs(randomNormal()*10.0)
